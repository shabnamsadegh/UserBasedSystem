<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Uploader.aspx.cs" Inherits="UserLoginSystem.PR.FileManager.WebForm1" %>
...
<body>
    ...
    <asp:Button ID="bntUpload" runat="server" Text="بارگذاری"  
